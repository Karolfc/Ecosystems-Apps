...
async function sendPlayer(player) { //Send a player
...
async function sendMove(player) { //Send a player's move
    const playerMOVE = {method: "POST", headers: {"Content-Type":"applicatio/json"}, body: JSON.stringify(player)};
