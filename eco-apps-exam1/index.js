...
//envia las instrucciones al juego (.broadcast para evitar eco)
io.on('connection', socket => {
    console.log(socket.id);
    socket.on('controller-instructions', instructions => {
        console.log(instructions);
        socket.broadcast.emit('game-instructions', instructions);
    });

    //envia el mensaje al juego (.broadcast para evitar eco)
